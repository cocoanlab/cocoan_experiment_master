...
global window_rect prompt_ex tb bb lb rb scale_W anchor_y anchor_y2 anchor promptW promptH joy_speed; % rating scale
...
circular = strcmp(overall_types, 'overall_avoidance_semicircular');
